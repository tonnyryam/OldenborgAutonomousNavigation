...
# Run training script
srun --nodes=1 --ntasks=1 --exclusive python training.py TeleportingStaticModel Summer2024Official "Training Model on Teleporting Static Data with MobileNetV4" MobileNetV4 Teleporting100kData --local_data
srun --nodes=1 --ntasks=1 --exclusive python training.py TeleportingRand10Model Summer2024Official "Training Model on Teleporting Randomized Textures every 10 Data with MobileNetV4" MobileNetV4 Teleporting100kRandEvery10Data --local_data
srun --nodes=1 --ntasks=1 --exclusive python training.py TeleportingRand50Model Summer2024Official "Training Model on Teleporting Randomized Textures every 50 Data  with MobileNetV4" MobileNetV4 Teleporting100kRandEvery50Data --local_data
