...
# Run training script
srun --nodes=1 --ntasks=1 --exclusive python ./../training.py TeleportingStaticResNet18 Summer2024Official "Training Model on Teleporting Static Data with ResNet18" ResNet18 Teleporting100kData --num_replicates 3
srun --nodes=1 --ntasks=1 --exclusive python ./../training.py TeleportingRand10ResNet18 Summer2024Official "Training Model on Teleporting Randomized Textures every 10 Data with ResNet18" ResNet18 Teleporting100kRandEvery10Data --num_replicates 3
srun --nodes=1 --ntasks=1 --exclusive python ./../training.py TeleportingRand50ResNet18 Summer2024Official "Training Model on Teleporting Randomized Textures every 50 Data  with ResNet18" ResNet18 Teleporting100kRandEvery50Data --num_replicates 3
