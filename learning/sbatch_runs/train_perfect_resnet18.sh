...
conda activate s24
srun --nodes=1 --ntasks=1 --exclusive python ./../../../training.py PerfectStaticModel Summer2024Official "training off 100k perfect navigator image dataset" ResNet18 Perfect100kData:v0/data --local_data
srun --nodes=1 --ntasks=1 --exclusive python ./../../../training.py PerfectRand10Model Summer2024Official "training off 100k perfect navigator every 10 image dataset" ResNet18 Perfect100kRandEvery10Data:v0/data --local_data
srun --nodes=1 --ntasks=1 --exclusive python ./../../../training.py PerfectRand50Model Summer2024Official "training off 100k perfect navigator every 50 image dataset" ResNet18 Perfect100kRandEvery50Data:v0/data --local_data
