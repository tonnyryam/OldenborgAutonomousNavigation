...
srun --nodes=1 --ntask=1 --exclusive python training.py PerfectStaticModel Summer2024Official "training off 100k perfect navigator image dataset with MobileNetV4" MobileNetV4 Perfect100kData
srun --nodes=1 --ntask=1 --exclusive python training.py PerfectRand10Model Summer2024Official "training off 100k perfect navigator every 10 image dataset with MobileNetV4" MobileNetV4 Perfect100kRandEvery10Data
srun --nodes=1 --ntask=1 --exclusive python training.py PerfectRand50Model Summer2024Official "training off 100k perfect navigator every 50 image dataset with MobileNetV4" MobileNetV4 Perfect100kRandEvery50Data
