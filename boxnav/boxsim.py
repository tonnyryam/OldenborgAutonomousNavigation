...
def simulate(args: Namespace) -> None:
    ...
    animation_pbar = enlighten_manager.counter(
        total=args.max_total_actions, desc="   Actions"
    )
    navigation_pbar = enlighten_manager.counter(total=100, desc="Completion")
    ...
    if args.anim_ext:
        ...
        num = 1
        while True:
            output_filename = f"output_{num:02}.{args.anim_ext}"
        ...
        animation_pbar = enlighten_manager.counter(total=total_actions, desc="Frames")
